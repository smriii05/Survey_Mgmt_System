...
public class MainPage {
	...
	public void mainPageView(int id) throws SQLException {
		...
		start.setFont(new Font("Colonna MT", Font.BOLD, 40));
		addPanel.add(start);
					...
					if(i==0) {
						...
						try {
							...
							for(int j=0; j<i; j++) {
								...
								JOptionPane.showMessageDialog(frame, "Survey Added. Survey Code : " + code, "Congratulations", JOptionPane.PLAIN_MESSAGE); 
						}
		...
		viewPanel.setBounds(0, 0, 600, 600);
		viewPanel.setLayout(null);
                viewPanel.setBackground(c2);
		...
		optionPanel.setBounds(600, 0, 200, 600);
		optionPanel.setBackground(c1);
		optionPanel.setLayout(null);
		frame.add(optionPanel);
		
		JButton addSurvey = new JButton("ADD SURVEY");
		addSurvey.setBounds(25, 113, 150, 50);
                addSurvey.setBackground(c2);
		...
		viewSurvey.setBounds(25, 276, 150, 50);
                viewSurvey.setBackground(c2);
		...
		logout.setBounds(25, 440, 150, 50);
